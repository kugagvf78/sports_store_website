...
<?php $component = App\View\Components\StatCard::resolve(['title' => 'Tổng khách hàng','value' => $totalCustomers,'icon' => 'fa-users','from' => 'blue-500','to' => 'blue-600','iconColor' => 'blue-600','fontSize' => 'text-3xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal179d930850cbc0b57567dfb2ba44c92f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal179d930850cbc0b57567dfb2ba44c92f = $attributes; } ?>
<?php $component = App\View\Components\StatCard::resolve(['title' => 'Hoạt động','value' => $activeCustomers,'icon' => 'fa-user-check','from' => 'green-500','to' => 'emerald-600','iconColor' => 'green-600','fontSize' => 'text-3xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal179d930850cbc0b57567dfb2ba44c92f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal179d930850cbc0b57567dfb2ba44c92f = $attributes; } ?>
<?php $component = App\View\Components\StatCard::resolve(['title' => 'Ngưng hoạt động','value' => $inactiveCustomers,'icon' => 'fa-user-clock','from' => 'amber-500','to' => 'orange-600','iconColor' => 'orange-600','fontSize' => 'text-3xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal179d930850cbc0b57567dfb2ba44c92f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal179d930850cbc0b57567dfb2ba44c92f = $attributes; } ?>
<?php $component = App\View\Components\StatCard::resolve(['title' => 'Bị khóa','value' => $bannedCustomers,'icon' => 'fa-user-slash','from' => 'red-500','to' => 'rose-600','iconColor' => 'red-600','fontSize' => 'text-3xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal179d930850cbc0b57567dfb2ba44c92f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal179d930850cbc0b57567dfb2ba44c92f = $attributes; } ?>
<?php $component = App\View\Components\StatCard::resolve(['title' => 'Tổng đơn hàng','value' => $totalOrders,'icon' => 'fa-shopping-bag','from' => 'purple-500','to' => 'violet-600','iconColor' => 'purple-600','fontSize' => 'text-3xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
    ...
    <div class="bg-white shadow-md rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Theo dõi và quản lý tài khoản khách hàng</p>
            </div>
...
<?php $component = App\View\Components\Ui\ActionButton::resolve(['href' => route('admin.customers.downloadTemplate'),'icon' => 'fa-file-excel','label' => 'Tải file mẫu','outline' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <form id="export-form" action="<?php echo e(route('admin.customers.export', request()->query())); ?>" method="GET"
                    class="inline-block">
                ...
                <?php if (isset($component)) { $__componentOriginalf95f399a33c6240aef137a9e6b350e45 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf95f399a33c6240aef137a9e6b350e45 = $attributes; } ?>
<?php $component = App\View\Components\Ui\ActionButton::resolve(['href' => route('admin.customers.create'),'icon' => 'fa-plus','label' => 'Thêm khách hàng'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.action-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component = App\View\Components\Form\Select::resolve(['name' => 'status','options' => ['1' => 'Hoạt động', '0' => 'Ngưng hoạt động', '2' => 'Bị khóa'],'placeholder' => 'Tất cả trạng thái'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <form id="bulk-form" method="POST">
            ...
            <div
                class="px-6 pb-5 flex flex-wrap gap-2 justify-start ">
                ...
                <button id="bulk-delete-btn" type="button"
                    class="cursor-pointer col-span-2 text-center bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm font-medium shadow transition">
                    ...
                    <table class="min-w-full text-sm text-gray-700">
                        <thead class="border-b border-gray-300 bg-gray-50 text-gray-700 uppercase text-xs">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center">
                                    <a href="<?php echo e(route('admin.customers.index', array_merge(request()->query(), ['sort' => 'created_at', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']))); ?>"
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <!-- Họ tên -->
                                <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($customer->full_name ?? '—'); ?></td>

                                <!-- Email -->
                                <td class="px-6 py-4 text-gray-700"><?php echo e($customer->email); ?></td>

                                <!-- SĐT -->
                                <td class="px-6 py-4 text-center text-gray-600"><?php echo e($customer->phone ?? '—'); ?></td>

                                <!-- Trạng thái -->
                                <td class="px-6 py-4 text-center">
                                    <button type="button"
                                        onclick="confirmUpdateCustomerStatus(event, '<?php echo e($customer->id); ?>', '<?php echo e($customer->status); ?>', '<?php echo e($customer->full_name); ?>')"
                                    ...
                                    <?php endif; ?>">
                                        ...
                                        <?php echo e($customer->status == 1 ? 'Hoạt động' : ($customer->status == 0 ? 'Ngưng hoạt động' : 'Bị khóa')); ?>
                                        ...
                                        <template x-teleport="body">
                                            <div
                                                ...
                                                <a href="<?php echo e(route('admin.customers.show', $customer)); ?>"
                                                    class="flex items-center gap-2 px-4 py-2.5 text-sm text-indigo-600 hover:bg-indigo-50 hover:text-indigo-700 transition">
                                                    <div class="w-5 flex justify-center"><i class="fas fa-eye"></i></div>
                                                    Xem chi tiết
                                                </a>

                                                <!-- ✏️ Chỉnh sửa -->
                                                <a href="<?php echo e(route('admin.customers.edit', $customer)); ?>"
                                                    class="flex items-center gap-2 px-4 py-2.5 text-sm text-blue-600 hover:bg-blue-50 hover:text-blue-700 transition">
                                                    <div class="w-5 flex justify-center"><i class="fas fa-edit"></i></div>
                                                    Chỉnh sửa
                                                </a>
                                                ...
                                                <button
                                                    type="button"
                                                    onclick="window.promptResetCustomerPassword('<?php echo e($customer->id); ?>', '<?php echo e($customer->full_name); ?>')"
                                                    class="w-full text-left flex items-center gap-2 px-4 py-2.5 text-sm text-indigo-600 hover:bg-indigo-50 hover:text-indigo-700 transition">
                                                    <div class="w-5 flex justify-center"><i class="fas fa-key"></i></div>
                                                    Đặt lại mật khẩu
                                                </button>

                                                <!-- 🗑️ Xóa -->
                                                <form action="<?php echo e(route('admin.customers.destroy', $customer)); ?>" method="POST"
                                                    onsubmit="window.confirmDelete(event, '<?php echo e($customer->full_name); ?>')"
                                                    class="block">
                                                    <?php echo csrf_field(); ?>
        ...
        <div
            class="px-6 pb-5 mt-4 border-t border-gray-200 bg-gray-50 flex justify-between items-center">
            <?php echo $customers->links('vendor.pagination.custom'); ?>

        </div>
    </div>
</div>

<?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin/products.js', 'resources/js/admin/customers.js']); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HUIT\HK7\PHP\DoAn\website-sports-store-main\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>